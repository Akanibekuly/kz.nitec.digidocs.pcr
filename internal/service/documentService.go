...
func newDocumentService(repo repository.PcrCertificate, conf *config.Services) *DocumentIfo {
	return &DocumentIfo{
		repo, conf,
	}
}
...
func (dc *DocumentIfo) GetServiceInfoByCode() (*models.Service, error) {
	return dc.repo.GetServiceInfoByCode(dc.conf.PcrCertificateCode)
}

func (dc *DocumentIfo) GetDocInfoByCode() (*models.Document, error) {
	return dc.repo.GetDocInfoByCode(dc.conf.PcrCertificateDocInfoCode)
}
